...
public class TintProgressDialog extends AlertDialog implements Handler.Callback {
    ...
    public static com.bilibili.magicasakura.widgets.TintProgressDialog show(Context context, CharSequence title,
    ...
    public static com.bilibili.magicasakura.widgets.TintProgressDialog show(Context context, CharSequence title,
        ...
        com.bilibili.magicasakura.widgets.TintProgressDialog dialog = new com.bilibili.magicasakura.widgets.TintProgressDialog(context);
